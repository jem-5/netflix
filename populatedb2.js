...
function dvdCreate(movie, status, cb) {
  dvdDetail = {
    movie: movie,
    status: status,
  };

  var dvd = new Dvd(dvdDetail);
  dvd.save(function (err) {
    if (err) {
      console.log("ERROR CREATING DVD: " + dvd);
      cb(err, null);
      return;
    }
    console.log("New DVD: " + dvd);
    dvds.push(dvd);
    cb(null, dvd);
  });
}
...
function createDvds(cb) {
  async.parallel(
    [
      function (callback) {
        dvdCreate(movies[0], "Available", callback);
      },
      function (callback) {
        dvdCreate(movies[0], "Available", callback);
      },
      function (callback) {
        dvdCreate(movies[0], "Loaned", callback);
      },
      function (callback) {
        dvdCreate(movies[1], "Loaned", callback);
      },
      function (callback) {
        dvdCreate(movies[2], "Maintenance", callback);
      },
      function (callback) {
        dvdCreate(movies[2], "Available", callback);
      },
      function (callback) {
        dvdCreate(movies[3], "Available", callback);
      },
      function (callback) {
        dvdCreate(movies[3], "Available", callback);
      },
      function (callback) {
        dvdCreate(movies[4], "Available", callback);
      },
      function (callback) {
        dvdCreate(movies[4], "Available", callback);
      },
      ...
      function (callback) {
        dvdCreate(movies[5], "Loaned", callback);
      },
      function (callback) {
        dvdCreate(movies[5], "Available", callback);
      },
      function (callback) {
        dvdCreate(movies[6], "Available", callback);
      },
      function (callback) {
        dvdCreate(movies[6], "Loaned", callback);
      },

      function (callback) {
        dvdCreate(movies[7], "Loaned", callback);
      },
      function (callback) {
        dvdCreate(movies[8], "Maintenance", callback);
      },
      function (callback) {
        dvdCreate(movies[8], "Available", callback);
      },
      function (callback) {
        dvdCreate(movies[9], "Loaned", callback);
      },
      function (callback) {
        dvdCreate(movies[9], "Available", callback);
      },

      function (callback) {
        dvdCreate(movies[10], "Available", callback);
      },
      function (callback) {
        dvdCreate(movies[10], "Loaned", callback);
      },
      function (callback) {
        dvdCreate(movies[10], "Available", callback);
      },
      ...
      function (callback) {
        dvdCreate(movies[10], "Maintenance", callback);
      },
      function (callback) {
        dvdCreate(movies[10], "Available", callback);
      },
...
async.series(
  [createGenreDirectors, createMovies, createDvds],
  // Optional callback
  function (err, results) {
    if (err) {
      console.log("FINAL ERR: " + err);
    } else {
      console.log("DVDInstances: " + dvds);
    }
